 ...
 import diet.server.ConversationController.WYSIWYGTube.TubeIn_InsertingFakeText_Balloon_Why;
 ...
 public class Dyadic_WYSIWYGInterface_Manipulation_Why
   extends Dyadic_WYSIWYGInterface_Manipulation
 {
   WYSIWYGTube wt = (WYSIWYGTube)new TubeIn_InsertingFakeText_Balloon_Why(this);
   ...
   public Dyadic_WYSIWYGInterface_Manipulation_Why(Conversation c) {
     super(c, 2, 6000);
   }
   ...
   public Dyadic_WYSIWYGInterface_Manipulation_Why(Conversation c, int numberOfTracks, int durationOfTimeout) {
     super(c, 2, 6000);
   }
