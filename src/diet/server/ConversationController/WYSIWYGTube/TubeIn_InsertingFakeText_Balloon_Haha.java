...
public class TubeIn_InsertingFakeText_Balloon_Haha
  extends Thread
  implements WYSIWYGTube
{
  TubeOut to;
    ...
    public String[] targets = new String[] { "haha", "lol", "hehe", "hoho", "lmfao", "lmao", "rofl", "rotfl" };
    public String[] queries = new String[] { "what's funny?" };
  ...
  public long timeSinceLastTurnChange() {
    ...
    public TubeIn_InsertingFakeText_Balloon_Haha(Dyadic_WYSIWYGInterface_Manipulation dw) { this.r = new Random(); this.dw = dw; this.to = new TubeOut(dw); boolean dosetup = CustomDialog.getBoolean("Do you want to customize the intervention settings?", "Customize", "Use default");
    if (dosetup)
      doSetup(); 
      start(); } 
    
    public void addFakeText(Participant fakeSender, String text, int minPreInterventionGap, int maxPreInterventionGap, int minIntraWordGap, int maxIntraWordGap, int minInterWordGap, int maxInterWordGap) { if (text == null)
        return;  
