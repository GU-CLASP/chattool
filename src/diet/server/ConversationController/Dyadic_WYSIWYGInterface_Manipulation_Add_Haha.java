 ...
 import diet.server.ConversationController.WYSIWYGTube.TubeIn_InsertingFakeText_Balloon_HahaAdd;
 ...
 public class Dyadic_WYSIWYGInterface_Manipulation_Add_Haha
   extends Dyadic_WYSIWYGInterface_Manipulation
 {
   WYSIWYGTube wt = (WYSIWYGTube)new TubeIn_InsertingFakeText_Balloon_HahaAdd(this);
   ...
   public Dyadic_WYSIWYGInterface_Manipulation_Add_Haha(Conversation c) {
     super(c, 2, 6000);
   }
   ...
   public Dyadic_WYSIWYGInterface_Manipulation_Add_Haha(Conversation c, int numberOfTracks, int durationOfTimeout) {
     super(c, 2, 6000);
   }
